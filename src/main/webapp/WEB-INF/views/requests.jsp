    ...
    <div class="generic-container">
        ...
        <div class="panel panel-default">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                <c:forEach items="${requests}" var="request" varStatus="i">
                    <tr>
                        <td>${request.user.username}</td>
                        <td>${request.friendId}</td>
                        
                            <td><a href="<c:url value='/acceptRequest/${requests[i.index].user.username}' />" class="btn btn-success custom-width">Add</a></td>
