package com.daniel.spring.configuration;
...
@ComponentScan({ "com.daniel.springsecurity.dao" })
public class HibernateTestConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.daniel.springsecurity.model" });
